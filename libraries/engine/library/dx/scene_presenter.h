...
struct dx_scene_presenter_Dispatch {
  ...
  Core_Result(*startup)(dx_scene_presenter* SELF, Core_Visuals_Context* context);
  Core_Result(*render)(dx_scene_presenter* SELF, Core_Visuals_Context* context, Core_Real32 delta_seconds, Core_Integer32 canvas_width, Core_Integer32 canvas_height);
  Core_Result(*shutdown)(dx_scene_presenter* SELF, Core_Visuals_Context* context);
};
...
/// @param SELF A pointer to this scene presenter.
/// @default-return
static inline Core_Result dx_scene_presenter_startup(dx_scene_presenter* SELF, Core_Visuals_Context* context) {
...
/// @default-return
static inline Core_Result dx_scene_presenter_render(dx_scene_presenter* SELF, Core_Visuals_Context* context, Core_Real32 delta_seconds, Core_Integer32 canvas_width, Core_Integer32 canvas_height) {
...
/// @default-return
static inline Core_Result dx_scene_presenter_shutdown(dx_scene_presenter* SELF, Core_Visuals_Context* context) {
