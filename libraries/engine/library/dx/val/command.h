...
Core_Result dx_val_command_construct_draw(dx_val_command* SELF, dx_val_vbinding* vbinding, Core_Visuals_Texture* texture, dx_val_cbinding* cbinding, dx_val_program* program, Core_Natural32 start, Core_Natural32 length);
...
/// @default-return
/// @default-failure
Core_Result dx_val_command_create_draw(dx_val_command** RETURN, dx_val_vbinding* vbinding, Core_Visuals_Texture* texture, dx_val_cbinding* cbinding, dx_val_program* program, Core_Natural32 start, Core_Natural32 length);
