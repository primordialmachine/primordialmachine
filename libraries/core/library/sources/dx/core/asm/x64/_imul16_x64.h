#if !defined(DX_ASM_X64__IMUL16_X64_H_INCLUDED)
#define DX_ASM_X64__IMUL16_X64_H_INCLUDED
...
int8_t _dx_imul16_x64(int8_t x, int8_t y, int8_t* z);

#endif

#endif // DX_ASM_X64__IMUL16_X64_H_INCLUDED
