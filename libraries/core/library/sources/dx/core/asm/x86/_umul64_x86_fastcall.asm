...
; uint32_t __fastcall _dx_umul64_x86_fastcall(uint32_t x, uint32_t y, uint32_t *z)
@_dx_umul64_x86_fastcall@12 PROC
  ...
  MUL edx                       ; edx@2 := hi(eax@1 * edx@1), eax@2 = lo(eax@1 * edx@1)
  ...
  RET 4
@_dx_umul64_x86_fastcall@12 ENDP
