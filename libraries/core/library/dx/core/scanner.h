...
struct dx_scanner_dispatch {
  ...
  dx_result(*set)(dx_scanner* SELF, char const* bytes, dx_size number_of_bytes);
  dx_result(*step)(dx_scanner* SELF);
  dx_result(*get_word_text_bytes)(char const** RETURN, dx_scanner* SELF);
  dx_result(*get_word_text_number_of_bytes)(dx_size* RETURN, dx_scanner* SELF);
  dx_result(*get_word_start_offset)(dx_size* RETURN, dx_scanner* SELF);
  dx_result(*get_word_end_offset)(dx_size* RETURN, dx_scanner* SELF);
};
