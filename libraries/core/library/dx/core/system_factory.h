...
struct dx_system_factory_dispatch {
  ...
  dx_result(*create_system)(dx_system**,dx_system_factory*, dx_msg_queue*);
};
...
/// @method-call.
static inline dx_result dx_system_factory_create_system(dx_system** RETURN, dx_system_factory* SELF, dx_msg_queue* msg_queue) {
