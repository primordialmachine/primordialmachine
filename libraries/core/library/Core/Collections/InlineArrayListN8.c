...
static Core_Result Core_InlineArrayListN8_removeManyBack(Core_InlineArrayListN8* SELF, Core_Size length) {
  return Core_InlineArrayListN8_removeMany(SELF, SELF->size - length, length);
}

static Core_Result Core_InlineArrayListN8_removeManyFront(Core_InlineArrayListN8* SELF, Core_Size length) {
