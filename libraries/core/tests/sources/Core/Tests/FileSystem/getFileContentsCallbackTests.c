...
static Core_Result Core_Tests_FileSystem_getFileContentsCallbackTest1() {
  ...
  if (Core_getFileContentsCallback(path, &array, &callback)) {
...
static Core_Result Core_Tests_FileSystem_getFileContentsCallbackTest2() {
  Core_InlineArrayListN8_Configuration arrayConfiguration = {
    .addedCallback = NULL,
    .removedCallback = NULL,
  };
...
Core_Result Core_Tests_FileSystem_getFileContentsCallbackTests() {
  if (Core_Tests_FileSystem_getFileContentsCallbackTest1()) {
    return Core_Failure;
  }
  if (Core_Tests_FileSystem_getFileContentsCallbackTest2()) {
    return Core_Failure;
  }
  return Core_Success;
}
