...
static inline dx_asset_image_dispatch* DX_ASSET_IMAGE_DISPATCH(void* p) {
  return (dx_asset_image_dispatch*)p;
}

struct dx_asset_image_dispatch {
...
dx_result dx_asset_image_construct_path(dx_asset_image* SELF,
                                        dx_string* name,
                                        dx_string* path);

dx_result dx_asset_image_create_path(dx_asset_image** RETURN,
                                     dx_string* name,
                                     dx_string* path);
