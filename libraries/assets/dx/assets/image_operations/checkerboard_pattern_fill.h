...
dx_result dx_assets_image_operations_checkerboard_pattern_fill_set_number_of_checkers_horizontal(dx_assets_image_operations_checkerboard_pattern_fill* SELF, dx_size number_of_checkers_horizontal);
...
/// @method{dx_assets_image_operations_checkerboard_pattern_fill}
dx_result dx_assets_image_operations_checkerboard_pattern_fill_get_number_of_checkers_horizontal(dx_size* RETURN, dx_assets_image_operations_checkerboard_pattern_fill* SELF);
...
/// @method{dx_assets_image_operations_checkerboard_pattern_fill}
dx_result dx_assets_image_operations_checkerboard_pattern_fill_set_number_of_checkers_vertical(dx_assets_image_operations_checkerboard_pattern_fill* SELF, dx_size number_of_checkers_vertical);

/// @brief Get the number of checkers along the vertical axis.
/// @param RETURN A pointer to a <code>dx_size</code>.
/// @success <code>*RETURN</code> was assigned the number of checkers along the vertical axis.
/// @method{dx_assets_image_operations_checkerboard_pattern_fill}
dx_result dx_assets_image_operations_checkerboard_pattern_fill_get_number_of_checkers_vertical(dx_size* RETURN, dx_assets_image_operations_checkerboard_pattern_fill* SELF);
...
/// @method{dx_assets_image_operations_checkerboard_pattern_fill}
dx_result dx_assets_image_operations_checkerboard_pattern_fill_set_checker_size_horizontal(dx_assets_image_operations_checkerboard_pattern_fill* SELF, dx_size checker_size_horizontal);

/// @brief Get the size of a checker along the horizontal axis.
/// @param RETURN A pointer to the dx_size variable.
/// @success <code>*RETURN</code> was assigned the size of a checker along the horizontal axis.
/// @method{dx_assets_image_operations_checkerboard_pattern_fill}
dx_result dx_assets_image_operations_checkerboard_pattern_fill_get_checker_size_horizontal(dx_size* RETURN, dx_assets_image_operations_checkerboard_pattern_fill* SELF);
...
/// @method{dx_assets_image_operations_checkerboard_pattern_fill}
dx_result dx_assets_image_operations_checkerboard_pattern_fill_set_checker_size_vertical(dx_assets_image_operations_checkerboard_pattern_fill* SELF, dx_size checker_size_vertical);
...
/// @method{dx_assets_image_operations_checkerboard_pattern_fill}
dx_result dx_assets_image_operations_checkerboard_pattern_fill_get_checker_size_vertical(dx_size* RETURN, dx_assets_image_operations_checkerboard_pattern_fill* SELF);
