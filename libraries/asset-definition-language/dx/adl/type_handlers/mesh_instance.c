...
static dx_result resolve(dx_adl_type_handlers_mesh_instance* SELF,
...
static dx_result resolve(dx_adl_type_handlers_mesh_instance* SELF, dx_adl_symbol* symbol, dx_adl_context* context) {
  if (symbol->resolved) {
    return DX_SUCCESS;
  }
