...
static Core_Result _enter(dx_adl_type_handlers_image* SELF, dx_ddl_node* node, dx_adl_context* context);
...
static Core_Result _enter(dx_adl_type_handlers_image* SELF, dx_ddl_node* source, dx_adl_context* context) {
  // type
  Core_String* received_type = NULL;
