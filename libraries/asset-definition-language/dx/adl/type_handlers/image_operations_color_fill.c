...
static dx_result _initialize_expected_keys(dx_adl_type_handlers_image_operations_color_fill* SELF);

static dx_result _uninitialize_expected_keys(dx_adl_type_handlers_image_operations_color_fill* SELF);

static dx_result _check_keys(dx_adl_type_handlers_image_operations_color_fill* SELF, dx_ddl_node* node);

static dx_result _parse(dx_object** RETURN, dx_adl_type_handlers_image_operations_color_fill* SELF, dx_ddl_node* node, dx_adl_context* context);

static dx_result _resolve(dx_adl_type_handlers_image_operations_color_fill* SELF, dx_adl_symbol* symbol, dx_adl_context* context);
