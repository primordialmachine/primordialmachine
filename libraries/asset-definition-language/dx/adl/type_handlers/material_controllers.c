...
static Core_Result _uninitialize_expected_keys(dx_adl_type_handlers_material_controllers* SELF);

static Core_Result _check_keys(dx_adl_type_handlers_material_controllers* SELF, dx_ddl_node* node);

static Core_Result _parse(Core_Object** RETURN, dx_adl_type_handlers_material_controllers* SELF, dx_ddl_node* node, dx_adl_context* context);

static Core_Result _resolve(dx_adl_type_handlers_material_controllers* SELF, dx_adl_symbol* symbol, dx_adl_context* context);

Core_defineObjectType("dx.adl.type_handlers.material_controllers",
...
Core_Result dx_adl_type_handlers_material_controllers_construct(dx_adl_type_handlers_material_controllers* SELF) {
  DX_CONSTRUCT_PREFIX(dx_adl_type_handlers_material_controllers);
...
static void dx_adl_type_handlers_material_controllers_constructDispatch(dx_adl_type_handlers_material_controllers_Dispatch* SELF) {
