...
$options['additional_css_stylesheets']= array('contents/assets/index.css?v=2');
  ...
  <main>
    <div class="container">
      ...
      <div class="center-column">
        <h1>Primordial Machine's Assets Library</h1>
        <p>
        Primordial Machine's Assets Library is a C library.
        The library provides a C API to work with asset definition language files.
        The library builds upon the code and the concepts provided by <a href=<?php echo '"' . App::getInstance()->site_url_prefix . 'core' . '"'?>>Primordial Machine's Core Library</a>.
        </p>
        <?php
        ...
        <nav>
          <ul>
            <?php
              ...
              $index = CdocIndexManager::getInstance()->getByName('assets');
              $index->sortEntries();
