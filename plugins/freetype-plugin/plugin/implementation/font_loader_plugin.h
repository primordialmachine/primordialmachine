...
/// @success
/// <code>_return<code> was assigned a pointer to an array of width*height pixels where
/// - width is the width in pixels of the glyph bitmap
/// - height h is the height in pixels of the glyph bitmap
...
typedef dx_font_loader_plugin_result(DX_FONT_LOADER_PLUGIN_GET_GLYPH_PIXELS_PROC)(dx_font_loader_plugin_glyph* glyph, void **pixels, uint32_t *width, uint32_t *height);
